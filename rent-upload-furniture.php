...
<section class="wrapper wrapper-grid grid grid-shadow">
	...
	<form action="functions-rent-furniture.php" method="post" enctype="multipart/form-data">
		...
		<div class="form-group text-center" style="position: relative;">
			...
			<a href="rent-list-furniture.php" align="right" class="btn btn-form">Settings</a>
	</form>
