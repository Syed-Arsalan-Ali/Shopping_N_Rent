<?php
    ...
    {    
        ...
        $query = " UPDATE sell SET name='$name', description='$description', email='$email', price='$price', contact='$contact', image='$filename' WHERE id='$student_id' ";
